...
int enc28j60PacketInfoReceive()
{
	...
	// read the packet length
	pck_len  = enc28j60ReadOp(ENC28J60_READ_BUF_MEM, 0);
	pck_len |= enc28j60ReadOp(ENC28J60_READ_BUF_MEM, 0)<<8;
